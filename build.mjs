...
console.log(`UI Registry Migration IV -> ${uiRegistryMigration.inventory.names.length} names; explicit blocks ${uiRegistryMigration.inventory.before.blocks} -> ${uiRegistryMigration.inventory.after.blocks}; entries ${uiRegistryMigration.inventory.before.entries} -> ${uiRegistryMigration.inventory.after.entries}; unique ${uiRegistryMigration.inventory.before.unique} -> ${uiRegistryMigration.inventory.after.unique}`);
