...
console.log(`State Registry Migration -> ${stateRegistryMigration.inventory.names.length} names; explicit entries ${stateRegistryMigration.inventory.before.entries} -> ${stateRegistryMigration.inventory.after.entries}; unique ${stateRegistryMigration.inventory.before.unique} -> ${stateRegistryMigration.inventory.after.unique}`);
