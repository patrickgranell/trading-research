...
console.log(`State Registry Migration II -> ${stateRegistryMigration.inventory.names.length} cumulative names (${stateRegistryMigration.inventory.batches.batch1.length}+${stateRegistryMigration.inventory.batches.batch2.length}); explicit entries ${stateRegistryMigration.inventory.before.entries} -> ${stateRegistryMigration.inventory.after.entries}; unique ${stateRegistryMigration.inventory.before.unique} -> ${stateRegistryMigration.inventory.after.unique}`);
