...
function trEventDiagnostics(){
  ...
  return {version:TR_EVENT_RUNTIME_VERSION,listeners:trEventListenersInstalled?TR_EVENT_TYPES.length:0,structuredHandlers:a.structuredHandlers,legacyProgramHandlers:a.legacyProgramHandlers,inlineHandlers:a.inlineHandlers,invalidActions:a.invalidActions,argsErrors:a.argsErrors,executionErrors:trEventExecErrors,asyncRejections:trEventAsyncRejections,asyncObserved:trEventAsyncObserved,dispatches:trEventDispatches,compiledPlans:Object.keys(TR_EVENT_COMPILED_PLANS).length,actionRegistrySize:trActionRegistrySize(),actionRegistryHits:trActionRegistryHits,registryMisses:trActionRegistryMisses,globalFallbacks:0,usesEval:false,usesParser:false,lastError:trEventLastError,ok:trEventListenersInstalled&&a.inlineHandlers===0&&a.legacyProgramHandlers===0&&a.invalidActions===0&&a.argsErrors===0&&!trEventExecErrors&&!trEventAsyncRejections&&!trActionRegistryMisses};
}
