...
if(typeof window.v313ReportScopeLabel==='function'){
  window.v313ReportScopeLabel=function(p=trPlanRead.current()){
...
if(typeof window.v313BuilderView==='function'){
  window.v313BuilderView=function(){
    const p=trPlanRead.current(),presets=trReportNormalizedPresets(p);
