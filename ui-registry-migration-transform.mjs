...
export const TR_UI_REGISTRY_MIGRATION_VERSION='31.23.43';
...
export function migrateUiHandlersToRegistry(source){
  ...
  const body=input.replace(SIMPLE_ASSIGN,(full,list)=>{
    ...
    return `${windowPart}${registryPart}/* V31.23.43 UI registry migration: ${moved.join(', ')} */`;
  });
