...
export const TR_UI_REGISTRY_MIGRATION_VERSION='31.23.46';
...
export const TR_UI_REGISTRY_MIGRATION_NAMES=Object.freeze([
  ...
  ...TR_UI_REGISTRY_MIGRATION_BATCH_27
]);
...
export function migrateUiHandlersToRegistry(source){
  ...
  const body=input.replace(SIMPLE_ASSIGN,(full,list)=>{
    ...
    for(const name of moved){
      ...
      if(batch27.has(name))batch27Entries++;
    }
    ...
    return `${windowPart}${registryPart}/* V31.23.46 UI registry migration: ${moved.join(', ')} */`;
  });
