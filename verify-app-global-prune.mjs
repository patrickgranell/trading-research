...
need(!app.includes('V31.23.9 pruned explicit window export'),'app.js fuente fue podado físicamente; esta fase debe mantener el histórico intacto y podar solo el bundle.');
...
need((result?.source.match(/V31\.23\.9 pruned explicit window export:/g)||[]).length===TR_APP_GLOBAL_PRUNE_TARGETS.length,`Marcadores V31.23.9 inesperados; se esperaban ${TR_APP_GLOBAL_PRUNE_TARGETS.length}.`);
