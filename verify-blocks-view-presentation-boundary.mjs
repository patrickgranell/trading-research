...
const EXPECTED_BLOCKS_SHA256='CAPTURE_RED';
const EXPECTED_BLOCK_CORE_SHA256='CAPTURE_RED';
const EXPECTED_CALC_METRIC_STATS_SHA256='CAPTURE_RED';
...
for(const [file,src] of runtimeSources){
  ...
  const count=[...executable.matchAll(/\bblocks\s*\(/g)].length;
