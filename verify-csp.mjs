...
need(index.indexOf('exit-lab-runtime.js')>index.indexOf('event-runtime.js')&&index.indexOf('exit-lab-runtime.js')<index.indexOf('csp-runtime.js'),'Exit Lab V31.24 debe cargar después del Action Registry y antes de CSP runtime.');
