...
need(structural.includes('globalThis.TradingResearchCurrentViewRouterFallbackWriteContract.toDashboard();'),'Cambió la escritura fallback del router fuera de alcance.');
...
console.log(' - boot restore + router fallback + navigation + plan-switch-open write boundaries preserved');
