...
need(app.includes("function trCoreQueueStateWrite(reason='persist'){\n  const snapshot=clone(state);"),'La deuda histórica que motiva el boundary cambió: revisar la estrategia de coalescing.');
