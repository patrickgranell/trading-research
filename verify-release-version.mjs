...
if(!index.includes(`name="trading-research-source-version" content="${EXPECTED}"`))fail.push('index source-version no coincide con V31.24.0');
if(!render.includes(`const TR_RELEASE_VERSION='${EXPECTED}'`))fail.push('falta TR_RELEASE_VERSION V31.24.0');
if(!render.includes("const TR_RELEASE_LABEL='V31.24 · Data Integrity Hardening'"))fail.push('falta label global V31.24');
...
console.log(' - product release = V31.24.0');
