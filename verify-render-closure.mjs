...
need(closure.includes("const TR_SOURCE_CONSOLIDATION_PHASE='31.23.11'"),'La tarjeta visible no identifica V31.23.11.');
need(closure.includes('Remaining Global Contract Map'),'Falta la etiqueta visible de Remaining Global Contract Map.');
...
for(const meta of ['trading-research-app-global-source-blocks','trading-research-app-global-bundled-blocks','trading-research-app-global-source-entries','trading-research-app-global-bundled-entries','trading-research-app-global-source-unique','trading-research-app-global-bundled-unique','trading-research-prune-safe-candidates','trading-research-dynamic-handler-slots','trading-research-dynamic-candidate-roots','trading-research-dynamic-protected-globals','trading-research-contract-map-remaining','trading-research-contract-map-classified','trading-research-contract-map-unclassified','trading-research-contract-map-multi','trading-research-contract-map-primary-state','trading-research-contract-map-primary-handler','trading-research-contract-map-primary-dynamic','trading-research-contract-map-state-frontier','trading-research-contract-map-handler-frontier','trading-research-contract-map-cross-runtime'])need(closure.includes(meta),`Source Consolidation no consume ${meta}.`);
need(closure.includes('sourceBlocks===51&&bundledBlocks===44'),'Source Consolidation no valida el cierre de bloques explícitos.');
need(closure.includes('sourceEntries===375&&bundledEntries===325'),'Source Consolidation no valida el cierre de entries.');
need(closure.includes('sourceUnique===332&&bundledUnique===286'),'Source Consolidation no valida el cierre de exports únicos.');
need(closure.includes('removedBlocks===7&&removedEntries===50&&removedUnique===46&&safeCandidates===0'),'Source Consolidation no conserva la guardia de cierre contract-safe.');
need(closure.includes('contractRemaining===286&&contractClassified===286&&contractUnclassified===0&&contractMulti===61'),'Source Consolidation no valida cobertura completa del mapa contractual.');
need(closure.includes('primaryState===60&&primaryHandler===223&&primaryDynamic===3'),'Source Consolidation no valida las categorías primarias del mapa.');
need(closure.includes('stateFrontier===56&&handlerFrontier===221&&crossRuntime===0'),'Source Consolidation no valida las fronteras de migración.');
...
console.log(' - Visible consolidation phase: V31.23.11 + Remaining Global Contract Map diagnostics');
