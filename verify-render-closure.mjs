...
need(closure.includes("const TR_SOURCE_CONSOLIDATION_PHASE='31.23.16'"),'La tarjeta visible no identifica V31.23.16.');
need(closure.includes('State Registry Migration V'),'Falta la etiqueta visible de State Registry Migration V.');
...
for(const meta of ['trading-research-app-global-source-blocks','trading-research-app-global-bundled-blocks','trading-research-app-global-source-entries','trading-research-app-global-bundled-entries','trading-research-app-global-source-unique','trading-research-app-global-bundled-unique','trading-research-state-registry-migrated','trading-research-state-registry-batch1','trading-research-state-registry-batch2','trading-research-state-registry-batch3','trading-research-state-registry-batch4','trading-research-state-registry-batch5','trading-research-prune-safe-candidates','trading-research-dynamic-handler-slots','trading-research-dynamic-candidate-roots','trading-research-dynamic-protected-globals','trading-research-contract-map-remaining','trading-research-contract-map-classified','trading-research-contract-map-unclassified','trading-research-contract-map-multi','trading-research-contract-map-primary-state','trading-research-contract-map-primary-handler','trading-research-contract-map-primary-dynamic','trading-research-contract-map-state-frontier','trading-research-contract-map-handler-frontier','trading-research-contract-map-cross-runtime'])need(closure.includes(meta),`Source Consolidation no consume ${meta}.`);
need(closure.includes('sourceBlocks===51&&bundledBlocks===44'),'Source Consolidation no valida el cierre de bloques explícitos.');
need(closure.includes('sourceEntries===375&&bundledEntries===283'),'Source Consolidation no valida la quinta migración de entries State.');
need(closure.includes('sourceUnique===332&&bundledUnique===246'),'Source Consolidation no valida la quinta migración de exports State.');
need(closure.includes('stateMigrated===40&&stateBatch1===8&&stateBatch2===8&&stateBatch3===8&&stateBatch4===8&&stateBatch5===8'),'Source Consolidation no valida los cinco lotes State de 8 acciones.');
need(closure.includes('removedBlocks===7&&removedEntries===92&&removedUnique===86&&safeCandidates===0'),'Source Consolidation no conserva la guardia acumulada.');
need(closure.includes('contractRemaining===246&&contractClassified===246&&contractUnclassified===0&&contractMulti===21'),'Source Consolidation no valida cobertura contractual post-migración V.');
need(closure.includes('primaryState===20&&primaryHandler===223&&primaryDynamic===3'),'Source Consolidation no valida categorías post-migración V.');
need(closure.includes('stateFrontier===16&&handlerFrontier===221&&crossRuntime===0'),'Source Consolidation no valida fronteras post-migración V.');
...
for(const name of ['v3110SetTargetTicks','v3110SetTrailGiveback','v3110SetTrailTrigger','v312DeleteMistake','v312MoveMistake','v312SaveMistake','v315OpenRunning','v315SetCursor'])need(closure.includes(name),`Panel V31.23.16 no identifica acción migrada ${name}.`);
...
console.log(' - Visible consolidation phase: V31.23.16 + State Registry Migration V diagnostics');
