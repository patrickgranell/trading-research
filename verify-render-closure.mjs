...
need(closure.includes("const TR_SOURCE_CONSOLIDATION_PHASE='31.23.10'"),'La tarjeta visible no identifica V31.23.10.');
need(closure.includes('Contract-Safe Export Closure'),'Falta la etiqueta visible de Contract-Safe Export Closure.');
...
need(closure.includes('sourceEntries===375&&bundledEntries===325'),'Source Consolidation no valida el tercer lote de entries.');
need(closure.includes('sourceUnique===332&&bundledUnique===286'),'Source Consolidation no valida el tercer lote de exports únicos.');
need(closure.includes('removedBlocks===7&&removedEntries===50&&removedUnique===46&&safeCandidates===0'),'Source Consolidation no valida el cierre contract-safe de la poda.');
...
need(closure.includes('0 candidatos adicionales')||closure.includes('0 candidatos'),'El panel no comunica el cierre del inventario contract-safe.');
...
console.log(' - Visible consolidation phase: V31.23.10 + Contract-Safe Export Closure diagnostics');
