...
need(closure.includes("const TR_SOURCE_CONSOLIDATION_PHASE='31.23.18'"),'visible consolidation phase is not V31.23.18');
...
for(const name of ['cloudPullState','deleteImportBatch','editOperation','navigate','openOperationModal','v314ImportMarketFile','v316Unlink','v319SyncExecutionSetsToOperations'])need(closure.includes(name),`V31.23.18 panel does not identify migrated action ${name}`);
...
console.log(' - Visible consolidation phase: V31.23.18 + State Registry Migration VII diagnostics');
