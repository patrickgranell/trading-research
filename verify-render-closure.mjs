...
need(closure.includes("const TR_SOURCE_CONSOLIDATION_PHASE='31.23.13'"),'La tarjeta visible no identifica V31.23.13.');
need(closure.includes('State Registry Migration II'),'Falta la etiqueta visible de State Registry Migration II.');
...
for(const meta of ['trading-research-app-global-source-blocks','trading-research-app-global-bundled-blocks','trading-research-app-global-source-entries','trading-research-app-global-bundled-entries','trading-research-app-global-source-unique','trading-research-app-global-bundled-unique','trading-research-state-registry-migrated','trading-research-state-registry-batch1','trading-research-state-registry-batch2','trading-research-prune-safe-candidates','trading-research-dynamic-handler-slots','trading-research-dynamic-candidate-roots','trading-research-dynamic-protected-globals','trading-research-contract-map-remaining','trading-research-contract-map-classified','trading-research-contract-map-unclassified','trading-research-contract-map-multi','trading-research-contract-map-primary-state','trading-research-contract-map-primary-handler','trading-research-contract-map-primary-dynamic','trading-research-contract-map-state-frontier','trading-research-contract-map-handler-frontier','trading-research-contract-map-cross-runtime'])need(closure.includes(meta),`Source Consolidation no consume ${meta}.`);
need(closure.includes('sourceBlocks===51&&bundledBlocks===44'),'Source Consolidation no valida el cierre de bloques explícitos.');
need(closure.includes('sourceEntries===375&&bundledEntries===308'),'Source Consolidation no valida la segunda migración de entries State.');
need(closure.includes('sourceUnique===332&&bundledUnique===270'),'Source Consolidation no valida la segunda migración de exports State.');
need(closure.includes('stateMigrated===16&&stateBatch1===8&&stateBatch2===8'),'Source Consolidation no valida los dos lotes State de 8 acciones.');
need(closure.includes('removedBlocks===7&&removedEntries===67&&removedUnique===62&&safeCandidates===0'),'Source Consolidation no conserva la guardia acumulada.');
need(closure.includes('contractRemaining===270&&contractClassified===270&&contractUnclassified===0&&contractMulti===45'),'Source Consolidation no valida cobertura contractual post-migración II.');
need(closure.includes('primaryState===44&&primaryHandler===223&&primaryDynamic===3'),'Source Consolidation no valida categorías post-migración II.');
need(closure.includes('stateFrontier===40&&handlerFrontier===221&&crossRuntime===0'),'Source Consolidation no valida fronteras post-migración II.');
...
for(const name of ['addConfig','removeConfig','addHypothesis','editHyp','resetPlanConfig','addEmotionConfig','removeEmotionConfig','savePlan'])need(closure.includes(name),`Panel V31.23.13 no identifica acción migrada ${name}.`);
...
console.log(' - Visible consolidation phase: V31.23.13 + State Registry Migration II diagnostics');
