...
import {migrateStateActionsToRegistry,TR_STATE_REGISTRY_MIGRATION_NAMES,TR_STATE_REGISTRY_MIGRATION_BATCH_1,TR_STATE_REGISTRY_MIGRATION_BATCH_2,TR_STATE_REGISTRY_MIGRATION_BATCH_3,TR_STATE_REGISTRY_MIGRATION_BATCH_4,TR_STATE_REGISTRY_MIGRATION_BATCH_5,TR_STATE_REGISTRY_MIGRATION_BATCH_6,TR_STATE_REGISTRY_MIGRATION_VERSION} from './state-registry-migration-transform.mjs';
...
if(TR_STATE_REGISTRY_MIGRATION_VERSION!=='31.23.17')throw new Error(`Versión de migración inesperada: ${TR_STATE_REGISTRY_MIGRATION_VERSION}`);
const batches=[TR_STATE_REGISTRY_MIGRATION_BATCH_1,TR_STATE_REGISTRY_MIGRATION_BATCH_2,TR_STATE_REGISTRY_MIGRATION_BATCH_3,TR_STATE_REGISTRY_MIGRATION_BATCH_4,TR_STATE_REGISTRY_MIGRATION_BATCH_5,TR_STATE_REGISTRY_MIGRATION_BATCH_6];
if(batches.some(b=>b.length!==8)||TR_STATE_REGISTRY_MIGRATION_NAMES.length!==48)throw new Error(`Lotes State inesperados: ${batches.map(b=>b.length).join('+')}=${TR_STATE_REGISTRY_MIGRATION_NAMES.length}.`);
...
console.log(` - Registry publications: ${inv.registryEntries} total; batches ${inv.batch1Entries}/${inv.batch2Entries}/${inv.batch3Entries}/${inv.batch4Entries}/${inv.batch5Entries}/${inv.batch6Entries}`);
...
console.log(` - Batch VI migrated: ${TR_STATE_REGISTRY_MIGRATION_BATCH_6.join(', ')}`);
