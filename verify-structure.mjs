...
if((app.match(/TradingResearchOperationsReadContract/g)||[]).length!==1)fail.push('TradingResearchOperationsReadContract debe publicarse exactamente una vez en app.js.');
if((app.match(/TradingResearchContextHelpPresentationContract/g)||[]).length!==1)fail.push('TradingResearchContextHelpPresentationContract debe publicarse exactamente una vez en app.js.');
if((app.match(/TradingResearchViewPresentationContract/g)||[]).length!==1)fail.push('TradingResearchViewPresentationContract debe publicarse exactamente una vez en app.js.');
if((app.match(/TradingResearchResearchStatusContract/g)||[]).length!==1)fail.push('TradingResearchResearchStatusContract debe publicarse exactamente una vez en app.js.');
if((app.match(/TradingResearchReportsSectionPresentationContract/g)||[]).length!==1)fail.push('TradingResearchReportsSectionPresentationContract debe publicarse exactamente una vez en app.js.');
if((app.match(/TradingResearchOperationsPresentationContract/g)||[]).length!==1)fail.push('TradingResearchOperationsPresentationContract debe publicarse exactamente una vez en app.js.');
if((app.match(/TradingResearchNavigationStateContract/g)||[]).length!==1)fail.push('TradingResearchNavigationStateContract debe publicarse exactamente una vez en app.js.');
if((app.match(/TradingResearchNavigationRuntimeStateContract/g)||[]).length!==1)fail.push('TradingResearchNavigationRuntimeStateContract debe publicarse exactamente una vez en app.js.');
if((app.match(/TradingResearchOperationChecklistPresentationContract/g)||[]).length!==1)fail.push('TradingResearchOperationChecklistPresentationContract debe publicarse exactamente una vez en app.js.');
...
console.log(' - app.js: audited V31.25 + Issue #12 source preserved byte-for-byte beneath exact terminal Plan-read + content-encoding + Exit-presentation + Form-boundary + Reports-presentation + Timeline-presentation + Date-presentation + Navigation-presentation + Operations-read + Context-Help-presentation + View-presentation + Research-status + Reports-section-presentation + Operations-presentation + Navigation-state + Navigation-runtime-state + Operation-checklist-presentation + Running-chart-presentation + Theme-read contracts');
