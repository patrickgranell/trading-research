...
if(pkg.version!=='31.14.3')fail.push(`Versión inesperada: ${pkg.version}`);
...
if(!stateRuntime.includes("const TR_STATE_RUNTIME_VERSION='31.14.3'"))fail.push('Falta State Runtime V31.14.3.');
...
console.log(' - State runtime: read-only render boundary + eager schema + DomainStore Proxy + UIStore');
