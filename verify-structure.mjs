...
if(pkg.version!=='31.14.2')fail.push(`Versión inesperada: ${pkg.version}`);
...
if(!stateRuntime.includes("const TR_STATE_RUNTIME_VERSION='31.14.2'"))fail.push('Falta State Runtime V31.14.2.');
...
console.log(' - State runtime: eager schema boundary + DomainStore Proxy + UIStore');
